...
const char* SALSHEXT_SHAREDMEMMUTEXNAME = "TCExten_SharedMemMutex1"; // Tandem Commander 0.1.0 (feature 032: disjoint from Open Salamander)
const char* SALSHEXT_SHAREDMEMNAME = "TCExten_SharedMem1";           // Tandem Commander 0.1.0
const char* SALSHEXT_DOPASTEEVENTNAME = "TCExten_DoPasteEvent1";     // Tandem Commander 0.1.0
...
const char* SHEXREG_OPENSALAMANDER = "TandemCommanderVer" SALSHEXT_SHAREDNAMESAPPENDIX;
#ifdef INSIDE_SALAMANDER
#include "versinfo.rh2"
const char* SHEXREG_OPENSALAMANDER_DESCR = "Shell Extension (%s) for Tandem Commander " VERSINFO_VERSION;
