...
- [ ] T002 [P] Replace raster set: copy all nine
...
- [ ] T003 Refresh doc text in `tools/brand/gen_icons.py` (module docstring
...
- [ ] T004 Run `python tools/brand/gen_icons.py` to regenerate
...
- [ ] T005 [US1] Structural + transparency check of `src/res/salamand.ico`:
...
- [ ] T006 [US1] Verify US1: `build.cmd` succeeds; visually confirm the
...
- [ ] T007 [P] [US2] Re-author nanosvg-safe `tools/brand/logo.svg` from the
...
- [ ] T008 [US2] Copy `tools/brand/logo.svg` over `src/res/logo.svg`
      (`IDB_LOGO_HAND` RCDATA — file name and ID unchanged)
- [ ] T009 [US2] Verify US2: nanosvg-render `logo.svg` at 256 px and
...
- [ ] T010 [US3] Verify US3: inspect the regenerated `src/res/sal_r.ico`,
...
- [ ] T011 [US4] Verify US4: `--verify` passes for
      `src/salmon/res/salmon.ico`, `src/setup/res/setup.ico`,
...
- [ ] T012 [P] Update `tools/brand/README.md`: revised artwork description
...
- [ ] T013 Full validation sweep per quickstart.md: regenerate everything
