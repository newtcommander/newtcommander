...
for %%t in (Debug_x86 Release_x86 Debug_x64 Release_x64) do (
  call :my_del "%OPENSAL_BUILD_DIR%tandemcommander\%%t\help\english\salamand.chw"
)

call "%OPENSAL_BUILD_DIR%tandemcommander\Debug_x86\help\english\salamand.chm"

for %%t in (          Release_x86 Debug_x64 Release_x64) do (
  call :mycopy_bat "%OPENSAL_BUILD_DIR%tandemcommander\Debug_x86\help\english\salamand.chw" "%OPENSAL_BUILD_DIR%tandemcommander\%%t\help\english\salamand.chw"
)
